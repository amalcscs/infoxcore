...
class hrprojectsgive(models.Model):
    ...
    json_testerscreenshot = models.CharField(max_length=200, default='')
    json_screenshot = models.CharField(max_length=200, default='')
...
class mangivetasks(models.Model):
    ...
    #json_screenshot = JSONField(blank=True, null=True)
    json_screenshot = models.CharField(max_length=120)
    submited = models.CharField(max_length=200, default='')
    ...
    testerdescr = models.CharField(max_length=200, default='')
    #json_testerscreenshot = JSONField(blank=True, null=True)
    json_testerscreenshot = models.CharField(max_length=120)
...
class TeamLeadweeklytask(models.Model):
    ...
    #json_screenshot = JSONField(blank=True, null=True)
    json_screenshot = models.CharField(max_length=200)
    description = models.CharField(max_length=3000)
    branch = models.CharField(max_length=200,default='')
...
class Project(models.Model):
    ...
    json_attachfile = models.CharField(max_length=200)
    branch = models.CharField(max_length=200)
...
class PrTasktoTL(models.Model):
    ...
    json_taskattachfile = models.CharField(max_length=2000)
...
class PrTasktoDR(models.Model):
    ...
    duedate = models.DateField()
    #json_taskattachfile = JSONField(blank=True, null=True)
    json_taskattachfile = models.CharField(max_length=100)
...
class Report(models.Model):
    ...
    json_attachfile = models.CharField(max_length=200,default='')
    branch = models.CharField(max_length=200,default='')
...
class Testing(models.Model):
    ...
    #json_attachfile = JSONField(blank=True, null=True)
    json_attachfile = models.CharField(max_length=100)
...
class qrcode1(models.Model):
    ...
    img = models.ImageField(upload_to='img/%y',max_length=10000,default='')
